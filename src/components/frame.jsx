    ...
    return (
        <div className="flex flex-row items-center justify-start space-x-1">
            ...
            <div className="flex flex-col items-start justify-start">
                <p className="text-small leading-base">{name}</p>
                <p className="text-small font-bold leading-base">{value}</p>
            </div>
        </div>
    );
}
        ...
        <Fragment>
            <div className="frame space-y-6">
                <div className="flex flex-row items-center justify-between space-x-4">
                    ...
                    <h1 className="text-black text-xxlarge font-bold">Patient</h1>
                    <Box>
                ...
                <Box>
                    <div className="flex flex-row items-center justify-between p-1 space-x-2">
