...
export type StopwatchHeight = "16" | "24";

export interface StopwatchProps extends SVGProps<SVGSVGElement> {
...
export default function Stopwatch({ height, ...props }: StopwatchProps) {
