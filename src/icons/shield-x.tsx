...
export type ShieldXHeight = "16" | "24";

export interface ShieldXProps extends SVGProps<SVGSVGElement> {
    height: ShieldXHeight;
}
...
export default function ShieldX({ height, ...props }: ShieldXProps) {
