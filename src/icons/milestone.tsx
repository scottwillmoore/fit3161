...
export type MilestoneHeight = "16" | "24";

export interface MilestoneProps extends SVGProps<SVGSVGElement> {
...
export default function Milestone({ height, ...props }: MilestoneProps) {
