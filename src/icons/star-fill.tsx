...
export type StarFillHeight = "16" | "24";

export interface StarFillProps extends SVGProps<SVGSVGElement> {
    height: StarFillHeight;
}
...
export default function StarFill({ height, ...props }: StarFillProps) {
