...
export type TasklistHeight = "16" | "24";

export interface TasklistProps extends SVGProps<SVGSVGElement> {
...
export default function Tasklist({ height, ...props }: TasklistProps) {
