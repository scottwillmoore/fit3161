...
export type ShieldLockHeight = "16" | "24";

export interface ShieldLockProps extends SVGProps<SVGSVGElement> {
    height: ShieldLockHeight;
}
...
export default function ShieldLock({ height, ...props }: ShieldLockProps) {
