...
export type HomeFillHeight = "24";

export interface HomeFillProps extends SVGProps<SVGSVGElement> {
    height: HomeFillHeight;
}
...
export default function HomeFill({ height, ...props }: HomeFillProps) {
