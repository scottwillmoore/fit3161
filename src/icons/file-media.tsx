...
export type FileMediaHeight = "24";

export interface FileMediaProps extends SVGProps<SVGSVGElement> {
    height: FileMediaHeight;
}
...
export default function FileMedia({ height, ...props }: FileMediaProps) {
