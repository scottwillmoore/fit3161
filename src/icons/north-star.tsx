...
export type NorthStarHeight = "16" | "24";

export interface NorthStarProps extends SVGProps<SVGSVGElement> {
    height: NorthStarHeight;
}
...
export default function NorthStar({ height, ...props }: NorthStarProps) {
