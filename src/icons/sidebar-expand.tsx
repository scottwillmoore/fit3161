...
export type SidebarExpandHeight = "16" | "24";

export interface SidebarExpandProps extends SVGProps<SVGSVGElement> {
    height: SidebarExpandHeight;
}
