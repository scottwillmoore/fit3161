...
export type FileBadgeHeight = "16";

export interface FileBadgeProps extends SVGProps<SVGSVGElement> {
    height: FileBadgeHeight;
}
...
export default function FileBadge({ height, ...props }: FileBadgeProps) {
