...
export type LogoGithubHeight = "16";

export interface LogoGithubProps extends SVGProps<SVGSVGElement> {
    height: LogoGithubHeight;
}
...
export default function LogoGithub({ height, ...props }: LogoGithubProps) {
