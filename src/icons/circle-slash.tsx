...
export type CircleSlashHeight = "16" | "24";

export interface CircleSlashProps extends SVGProps<SVGSVGElement> {
    height: CircleSlashHeight;
}
...
export default function CircleSlash({ height, ...props }: CircleSlashProps) {
