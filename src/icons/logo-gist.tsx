...
export type LogoGistHeight = "16";

export interface LogoGistProps extends SVGProps<SVGSVGElement> {
    height: LogoGistHeight;
}
...
export default function LogoGist({ height, ...props }: LogoGistProps) {
