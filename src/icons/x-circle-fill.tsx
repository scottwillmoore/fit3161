...
export type XCircleFillHeight = "16" | "24";

export interface XCircleFillProps extends SVGProps<SVGSVGElement> {
    height: XCircleFillHeight;
}
...
export default function XCircleFill({ height, ...props }: XCircleFillProps) {
