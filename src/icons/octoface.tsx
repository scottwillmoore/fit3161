...
export type OctofaceHeight = "16" | "24";

export interface OctofaceProps extends SVGProps<SVGSVGElement> {
    height: OctofaceHeight;
}
...
export default function Octoface({ height, ...props }: OctofaceProps) {
