...
export default function Index() {
    return (
        <div className="bg-gray-50 absolute w-screen h-screen">
            ...
            <div className="mx-2">
                <div className="border-gray-400 -mt-4 p-2 bg-white border shadow-lg space-y-2">
                ...
                <div className="border-gray-400 divide-gray-400 mt-4 bg-white border shadow-lg divide-y">
                ...
                <button className="bg-blue-500 font-extrabold text-sm flex items-center justify-between mt-4 px-2 py-1.5 w-full text-white shadow-lg">
