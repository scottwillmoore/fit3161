    ...
    return (
        <Container title="Patient" description="">
            <Header>
                <h1>Patient</h1>
                <p>
                    <PersonIcon size={12} /> Patient ID: ****** <HourglassIcon size={12} />{" "}
                    01/01/2021
                </p>
            </Header>
            <Main>
                <form className={css.form}>
                    ...
                    <label>
                        ...
                        <div className={css.card}>
                            ...
                            <p>
                                Measures length of post-traumatic amnesia (PTA) in people with
                    ...
                    <label>
                        ...
                        <div className={css.card}>
                            ...
                            <p>
                                Measures behavioral aspects of agitation during the acute phase of
