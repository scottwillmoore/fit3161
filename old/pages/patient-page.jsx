import { BeakerIcon, BookIcon, PersonIcon, HourglassIcon, HistoryIcon, Container, Header, Main } from "app/components";
    ...
    return (
        <Container title="Patient" description="">
            <Header>
                <h1>Patient</h1>
                <p>
                    <PersonIcon size={12} /> Patient ID: ****** <HourglassIcon size={12} /> 01/01/2021
                </p>
            </Header>
            <Main>
                <form className={css.form}>
                    ...
                    <label>
                        <input type="radio" name="answer" value="absent" required className={css.hidden} />
                        <div className={css.card}>
                            <h1>Westmead Post Traumatic Test Scale</h1>
                            <p>Measures length of post-traumatic amnesia (PTA) in people with traumatic brain injury</p>
                        </div>
                    </label>
                    ...
                    <label>
                        ...
                        <div className={css.card}>
                            ...
                            <p>
                                Measures behavioral aspects of agitation during the acute phase of recovery from
