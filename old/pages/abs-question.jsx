            ...
            <Main>
                <form className={css.form}>
                    <div className={css.question}>
                        ...
                        <h1>Short attention span, easy distractibility and inability to concentrate.</h1>
                    </div>
                    <label>
                    ...
                    <label>
                        ...
                        <div className={css.card}>
                            ...
                            <p>
                                The individual needs to be redirected from an agitated to an appropriate behavior, but
                    ...
                    <label>
                        ...
                        <div className={css.card}>
                            ...
                            <p>
                                The individual is not able to engage in appropriate behavior due to the interference of
                                their agitated behavior, even when external cues or redirection is provided.
                            </p>
                        </div>
                    </label>
                    <Button type="button">
